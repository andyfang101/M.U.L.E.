 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Eileen");
		  toPrint += p1.toString("902834278");
		  ...
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Kushal");
		  toPrint += p3.toString("902880985");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Cassidy");
          toPrint += p4.toString("902743132");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Wei");
          toPrint += p5.toString("902648084");
